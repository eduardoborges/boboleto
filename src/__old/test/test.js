...
describe('Boleto Inválido', () => {
  describe('Caracteres Inválidos', () => {
    it('deve retornar Objeto com {sucesso: false}', () => {
      expect(boleto.validarBoleto('jiuajs')).to.have.property('sucesso').to.be.false;
    });
  });
  describe('Fora do limite de caracteres', () => {
    it('deve retornar Objeto com {sucesso: false}', () => {
...
describe('Boletos de 5 campos', () => {
  describe('Boleto Bancário', () => {
    describe('Código de barras', () => {
      it('deve retornar Objeto com informações do boleto', () => {
  ...
  describe('Boleto de Cartão de Crédito', () => {
    describe('Código de barras', () => {
      it('deve retornar Objeto com informações do boleto', () => {
...
describe('Conversão entre linha digitável e código de barras', () => {
  describe('Converter código de barras para linha digitável', () => {
    describe('Sem formatação', () => {
      it('deve retornar linha digitável numérica válida a partir do código de barras inserido', () => {
    ...
    describe('Com formatação', () => {
      it('deve retornar linha digitável com formatação válida a partir do código de barras inserido', () => {
        result = boleto.codBarras2LinhaDigitavel('85820000000572503282035607082021053959190446', true);
        expect(result).to.equal('858200000007572503282030560708202107539591904460');
      });
    });
  });
  describe('Converter linha digitável para código de barras', () => {
    it('deve retornar código de barras válido a partir da linha digitável inserida', () => {
